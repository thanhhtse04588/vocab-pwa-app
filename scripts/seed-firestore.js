...
const sampleSets = [
  {
    ...
    description: "Essential English sentences for daily conversations and everyday situations",
    language: "en",
    category: "daily-life",
    difficulty: "beginner",
    words: [
      ...
      },
      {
        ...
        exampleTranslation: "Tôi đang bận. Chúng ta có thể nói chuyện sau được không?"
      },
      {
        word: "I'm sorry.",
      ...
      },
      {
        ...
        exampleTranslation: "Có thể chúng ta có thể đi vào ngày mai thay vào đó."
      },
      {
        word: "I think so.",
      ...
      },
      {
        ...
        exampleTranslation: "Bây giờ tôi cảm thấy khỏe hơn. Cảm ơn bạn đã hỏi thăm."
      },
      {
      ...
      },
      {
        ...
        exampleTranslation: "Tôi không nói tiếng Anh giỏi, nhưng tôi đang cố gắng."
      },
      {
      ...
      },
      {
        ...
        exampleTranslation: "Để tôi suy nghĩ về việc này và tôi sẽ cho bạn biết."
      },
      {
      ...
      },
      {
        ...
        exampleTranslation: "Tôi quên mật khẩu. Bạn có thể giúp tôi đặt lại không?"
      },
      {
      ...
      },
      {
        ...
        exampleTranslation: "Chúc bạn một ngày tuyệt vời! Hẹn gặp lại ngày mai."
      }
    ],
    createdAt: new Date().toISOString(),
    isPublic: true,
    author: "System",
    tags: ["daily", "conversation", "beginner", "english"]
  }
];
